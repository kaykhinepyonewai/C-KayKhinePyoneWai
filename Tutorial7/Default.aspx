...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div>
      ...
      <br /><br />
      <asp:Label ID="lblGamil" runat="server" Text="Gamil"></asp:Label>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:TextBox ID="txtGamil" runat="server"></asp:TextBox>
      &nbsp;&nbsp;
    
     &nbsp;
      <asp:RequiredFieldValidator ID="reqGmail" runat="server" ErrorMessage="Please Fill Gmail" ControlToValidate="txtGamil" ForeColor="#FF0066"></asp:RequiredFieldValidator>
        &nbsp;  &nbsp; 
      <asp:RegularExpressionValidator ID="revGmail" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"  ControlToValidate="txtGamil" ErrorMessage="Please Format Gmail" ForeColor="#FF0066"></asp:RegularExpressionValidator>
      <br />
      <br />
